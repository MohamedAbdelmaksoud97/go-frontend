...
const configs: MasterConfig[] = [
  ...
  {
    id: "roles", label: "أدوار النظام المتقدمة", description: "استثناءات تقنية للحسابات الإدارية فقط. صلاحيات الموظف المعتادة تُدار من المسمى الوظيفي.", permission: "iam.roles.read", managePermission: "iam.roles.manage", path: "/organizations/{organizationId}/roles", createPath: "/organizations/{organizationId}/roles", updatePath: id => `/organizations/{organizationId}/roles/${id}/permissions`,
  ...
  {
    id: "role-assignments", label: "تكليفات الصلاحيات الاستثنائية", description: "تُستخدم فقط لمنح استثناء إداري مباشر. الموظف العادي يأخذ فرعه وصلاحياته من تكليفه الوظيفي.", permission: "iam.roles.read", managePermission: "iam.assignments.manage", path: "/organizations/{organizationId}/role-assignments", createPath: "/organizations/{organizationId}/role-assignments",
...
const navigationGroups = [
  ...
  { label: "إدارة متقدمة", ids: ["roles", "role-assignments"] },
