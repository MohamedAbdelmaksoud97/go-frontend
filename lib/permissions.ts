...
export const permissionImplications:Readonly<Record<string,readonly string[]>>={
 ...
 "files.manage":["files.read"],"attendance.devices.manage":["attendance.devices.read"],"catalog.manage":["catalog.read"],"catalog.availability.manage":["catalog.read"],
 ...
 "attendance.check-in":["attendance.read","members.read","subscriptions.read"],"bookings.create":["bookings.read","members.read","catalog.read"],"bookings.manage":["bookings.read","members.read","catalog.read"],"bookings.facilities.manage":["bookings.read","coaching.read"],
...
export const routePermissions:Record<string,string[]>={
 ...
 "/access-control":["attendance.devices.read","attendance.devices.manage"],
