...
const messages: Record<string, string> = {
  ...
  member_buyer_required:
    "هذا النوع من المبيعات يتطلب اختيار عضو مسجل. أما الحجز فيمكن فوترته لعضو أو لزائر ببيانات اسم وجوال صحيحة.",
  ...
  cash_shift_required:
    "الدفع النقدي يحتاج وردية صندوق مفتوحة على نقطة التحصيل المختارة. افتح الوردية أو اختر وسيلة دفع غير نقدية ثم أعد المحاولة.",
  ...
  fingerprint_pin_already_assigned: "رقم البصمة الرقمي مستخدم بالفعل لشخص آخر. استخدم PIN مختلفًا أو راجع ربط الشخص الحالي.",
  credential_subject_not_found: "لم يعد العضو أو الموظف المحدد موجودًا. حدّث نتائج البحث ثم اختره مجددًا.",
  access_device_version_conflict: "تغيرت إعدادات لوحة البوابة من جلسة أخرى. حدّث الصفحة قبل إعادة الحفظ.",
  access_device_branch_inactive: "لا يمكن ربط لوحة بفرع غير نشط. فعّل الفرع أولًا أو اختر فرعًا نشطًا.",
  access_device_not_found: "لوحة البوابة المطلوبة غير موجودة أو لم تعد متاحة في هذا النادي.",
  access_device_disabled: "لوحة البوابة معطلة من إعدادات GO. فعّلها قبل إعادة تشغيل الـBridge.",
  access_device_in_maintenance: "لوحة البوابة في وضع الصيانة ولا تستقبل أحداثًا الآن. استأنفها من شاشة البوابات والبصمة.",
  access_device_clock_ahead: "ساعة لوحة البوابة متقدمة عن الخادم بأكثر من خمس دقائق. صحح وقت كمبيوتر النادي أو اللوحة.",
  access_device_event_too_old: "هذا الحدث أقدم من مدة الاستيراد المسموحة (30 يومًا) ولم تتم إضافته.",
  ...
  retail_cashier_checkout_required:
    "شراء منتجات المتجر يتم من نقطة البيع بواسطة موظف مخوّل؛ لا يمكن إتمام هذا النوع من الشراء من بوابة العضو.",
};
