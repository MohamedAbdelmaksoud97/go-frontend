...
const messages: Record<string, string> = {
  self_trainer_not_found: "حساب الموظف غير مرتبط بملف مدرب نشط. أنشئ ملف المدرب واربطه بالموظف ثم عيّنه إلى الفرع.",
  trainer_not_found: "ملف المدرب المحدد غير موجود أو لم يعد متاحًا في هذا النادي.",
  trainer_not_active: "ملف المدرب غير نشط. فعّله أولًا قبل إنشاء أي تعيين جديد.",
  trainer_branch_assignment_missing: "المدرب غير معيّن إلى الفرع خلال الفترة المحددة. عيّنه إلى الفرع أولًا ثم أعد المحاولة.",
  coaching_conflict: "يوجد تعيين متداخل أو مكرر بالفعل. راجع تعيينات المدرب والعضو والفترة المحددة.",
