...
export const permissionSubjects: Record<string, string> = {
  ...
  attendance: "دخول الأعضاء", "attendance.devices": "البوابات وأجهزة البصمة", bookings: "الحجوزات", "bookings.facilities": "المرافق", "access-credentials": "بطاقات الدخول", lockers: "الخزائن",
